...
export function IncomeForm({ onSave, isSaving }: IncomeFormProps) {
	...
	const selectedCategory =
		incomeCategories.find((category) => category.id === selectedCategoryId) ??
		null;
		...
		<View style={styles.container}>
			...
			>
				...
				{incomeCategories.length === 0 && (
					<Menu.Item title="No income categories yet" disabled />
				)}
			</Menu>
