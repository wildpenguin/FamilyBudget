    ...
    return (
        <View>
            <View style={styles.headerRow}>
                ...
                <Text style={{ fontSize: 12, color: theme.colors.onSurfaceVariant }}>{data.length} months</Text>
            </View>
                            ...
                            <View style={styles.bars}>
                                <View
                                    style={[
                                        styles.bar,
                                        {
                                            height: Math.max((point.income / maxValue) * CHART_HEIGHT, 4),
                                ...
                                <View
                                    style={[
                                        styles.bar,
                                        {
                                            height: Math.max((point.expenses / maxValue) * CHART_HEIGHT, 4),
