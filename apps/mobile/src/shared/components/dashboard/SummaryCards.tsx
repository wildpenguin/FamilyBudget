    ...
    return (
        <View style={styles.row}>
            <SummaryCard
                ...
                icon="arrow-up"
                tint={{ background: theme.colors.tertiaryContainer, foreground: theme.colors.tertiary }}
                theme={theme}
            />
            <SummaryCard
                label="Expenses"
                ...
                icon="arrow-down"
                tint={{ background: theme.colors.errorContainer, foreground: theme.colors.error }}
                theme={theme}
            />
        </View>
    );
...
function SummaryCard({ label, amount, icon, tint, theme }: SummaryCardProps) {
    ...
    return (
        <View style={[styles.card, { backgroundColor: theme.colors.surfaceVariant }]}>
            ...
            <Text style={[styles.amount, { color: theme.colors.onSurface }]}>{formatted}</Text>
        </View>
    );
}
