...
import { Button, HelperText, Icon, Menu, Text, TextInput, TouchableRipple, useTheme } from 'react-native-paper';
...
export function ExpenseForm({ onSave, isSaving }: ExpenseFormProps) {
    ...
    const expenseCategories = (categoriesQuery.data ?? []).filter((category) => category.type === 'expense');
    ...
    const isAmountValid = amountText.trim().length > 0 && !Number.isNaN(parsedAmount) && parsedAmount > 0;
    ...
    return (
        <View style={styles.container}>
                ...
                anchor={
                    ...
                    >
                        <View style={styles.selectorRow}>
                            <Text style={{ fontSize: 12, color: theme.colors.onSurfaceVariant }}>Category</Text>
            ...
            >
                ...
                {expenseCategories.length === 0 && <Menu.Item title="No expense categories yet" disabled />}
            </Menu>
