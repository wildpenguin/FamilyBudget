    ...
    return (
        ...
        >
            <View style={styles.headerRow}>
                <View>
                    <Text style={{ fontSize: 13, color: theme.colors.onSurfaceVariant }}>Good morning</Text>
                    <Text style={{ fontSize: 17, fontWeight: '600', color: theme.colors.onSurface }}>Alex</Text>
                </View>
                <Avatar.Icon size={38} icon="account" />
            </View>

            <View style={styles.section}>
                <BalanceCard data={balanceQuery.data} isLoading={balanceQuery.isPending} />
            </View>

            <View style={styles.section}>
                <SummaryCards data={periodSummaryQuery.data} />
            </View>
